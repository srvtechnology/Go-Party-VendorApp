...
class _SingleServiceState extends State<SingleService> {
  ...
  final CustomFieldController _service =
      CustomFieldController(title: "Service", key: "service_id");
  final CustomFieldController _description =
      CustomFieldController(title: "Description", key: "service_desc");
  final CustomFieldController _material = CustomFieldController(
      title: "Material Description", key: "material_desc");
  final CustomFieldController _address =
      CustomFieldController(title: "Address", key: "address");
  final CustomFieldController _price =
      CustomFieldController(title: "Price", key: "price");
  final CustomFieldController _driverName =
      CustomFieldController(title: "Driver Name", key: "driver_name");
  final CustomFieldController _driverMob = CustomFieldController(
      title: "Driver Mobile Number", key: "driver_mobile_no");
  final CustomFieldController _driverKycType =
      CustomFieldController(title: "Driver Kyc Type", key: "driver_kyc_type");
  final CustomFieldController _driverKycNo =
      CustomFieldController(title: "Driver KYC Number", key: "dricer_kyc_no");
  final CustomFieldController _licenseNo = CustomFieldController(
      title: "Driver License Number", key: "driver_licence_no");
  final CustomFieldController _driverPinCode =
      CustomFieldController(title: "Driver Pin Code", key: "driver_pincode");
  final CustomFieldController _driverHouseNo = CustomFieldController(
      title: "Driver House Number", key: "driver_house_no");
  final CustomFieldController _driverArea =
      CustomFieldController(title: "Driver Area", key: "driver_area");
  final CustomFieldController _driverLandmark =
      CustomFieldController(title: "Driver Landmark", key: "driver_landmark");
  final CustomFieldController _driverCity =
      CustomFieldController(title: "Driver City", key: "driver_city");
  final CustomFieldController _driverState =
      CustomFieldController(title: "Driver State", key: "driver_state");
  final CustomFieldController _pinCode =
      CustomFieldController(title: "Pin Code", key: "pin_code");
  ...
  void initState() {
    ...
    listOfImages = widget.service.listImage;
          ...
          return GestureDetector(
            ...
            child: Scaffold(
                appBar: AppBar(
                  ...
                  elevation: 0,
                  iconTheme:
                      IconThemeData(color: UIColor.toolbar_content_color),
                    ...
                    : SingleChildScrollView(
                        child: Form(
                            ...
                            child: CustomMaterialBox(listOfChildren: [
                                                    ...
                                                    TextButton(
                                                      ...
                                                      onPressed: () {
                                                        Navigator.of(context)
                                                            .pop(); // Close the dialog
                                                        deleteService(
                                                            state); // Execute the confirmation action
                                                      },
                                                    ),
                                                  ],
                                                );
                              ...
                              ShowNonEditableTile("Service Name",
                                  widget.service.serviceName, false),
                              /*if(canEdit)*/ DetailTile(
                                  "Company Name", widget.service.company,
                                  controller: _companyName.controller,
                                  editable: canEdit,
                                  requiredField: false),
                              ShowNonEditableTile(
                                  "Status", widget.service.status, canEdit),
                              ...
                              /* if(canEdit) */ DetailTile(
                                  "Pin Code", widget.service.pin_code,
                                  controller: _pinCode.controller,
                                  editable: canEdit,
                                  isPinCode: true,
                                  digits: true),
                              if (canEdit)
                             ...
                             if(canEdit)
                              ...
                              DetailTile("Video Link", widget.service.videoUrl,
                                  controller: _videoUrl.controller),
                              DetailTile("Price", widget.service.price,
                                  controller: _price.controller, digits: true),
                              ShowNonEditableTile(
                                  "Created Date",
                                  DateFormat("dd-MM-yyyy hh:mm a").format(
                                      DateTime.parse(
                                          widget.service.created_at ?? "")),
                                  canEdit),
                                  ...
                                  children: [
                                        ...
                                        children: [
                                          ...
                                          OutlinedButton(
                                              onPressed: () async {
                                                ...
                                                var imagesLeftToAdd =listOfImages.where((element)=> element.url==null ).length;
                                                if(imagesLeftToAdd==0){
                                                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Already 5 images are uploaded. You cannot upload more until you delete one. The maximum supported number of images is 5.")));
                                                  return;
                                                }


                                                List<XFile?> images = await ImagePicker().pickMultiImage();
                                                  images.forEach((_element){
                                                    var isListFull = listOfImages.where((_element) => _element.url==null).isEmpty;
                                                        if(isListFull) return;
                                                        else{
                                                        setState(() {
                                                          var imageToUpdate = listOfImages.firstWhere((_element)=> _element.url==null);
                                                          imageToUpdate.isNetwork=false;
                                                          imageToUpdate.url = _element!.path;
                                                        });
                                    ...
                                    /*            if (productImages.length >= 5) {
                                                ...
                                                setState(() {
                                                  if (images.length >
                                                      remainingCount) {
                                                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Maximum ${remainingCount} photos allowed")));
                                                  }
                                                    ...
                                                    productImages.add(
                                                        AddProductPhoto(
                                                            ...
                                                            onDelete: (id) async{
                                                              ...
                                                              final element = widget.service.listImage?.firstWhere((_element) => _element.url == productImages[id].filePath);
                                                              if(productImages[id].network && element!=null) {
                                                                setState(() {
                                                                  isLoading=!isLoading;
                                                                });
                                                               final response =  await serviceRepo.deleteImage(auth, widget.service.id, element!.keyName);
                                                                setState(() {
                                                                  isLoading=!isLoading;
                                                                });
                              ...
                              /*      ...productImages,*/
                                  ...
                                  _buildImageLayout(onDeleteClick: (imageUrl,position) async{

                                    var availableImages = listOfImages.where((_element)=> _element.url!=null).length;
                                    ...
                                    if(imageUrl.isNetwork){
                                      /* call the API to delete the image */
                                      setState(() {
                                          isLoading=!isLoading;
                                        });
                                        final response =  await serviceRepo.deleteImage(auth, widget.service.id, imageUrl.keyName);
                                        setState(() {
                                          isLoading=!isLoading;
                                          listOfImages[position].url=null;
                                      ...
                                      /* manually set the url to null */
                                      setState(() {
                                        listOfImages[position].url=null;
                                       // listOfImages[position].isNetwork=false;
                                      });
                                    }
                                  })
                              ...
                              if (widget.service.imageUrls.first != null &&
                                  !canEdit)
                                Column(
                                  children: [
                                    Container(
                                    ...
                                    Container(
                                      ...
                                      child: ListView(
                                        ...
                                        children: widget.service.imageUrls
                                ...
                                Column(
                                  children: [
                                      ...
                                      children: [
                                        Expanded(
                                            child: DetailTile(
                                                "Name",
                                                widget
                                                    .service.driverDetails.name,
                                                controller:
                                                    _driverName.controller)),
                                        Expanded(
                                            child: DetailTile(
                                                "Mobile number",
                                                widget.service.driverDetails
                                                    .mobileNumber,
                                                controller:
                                                    _driverMob.controller)),
                                      ],
                                    ),
                                    Row(
                                      children: [
                                        ...
                                        Expanded(
                                            child: DetailTile(
                                                ...
                                                widget.service.driverDetails
                                                    .houseNumber,
                                                controller:
                                                    _driverHouseNo.controller)),
                                        Expanded(
                                            child: DetailTile(
                                                "Area",
                                                widget
                                                    .service.driverDetails.area,
                                                controller:
                                                    _driverArea.controller)),
                                      ],
                                    ),
                                    Row(
                                      children: [
                                        Expanded(
                                            child: DetailTile(
                                                "City",
                                                widget
                                                    .service.driverDetails.city,
                                                controller:
                                                    _driverCity.controller)),
                                        Expanded(
                                            child: DetailTile(
                                                "State",
                                                widget.service.driverDetails
                                                    .state,
                                                controller:
                                                    _driverState.controller)),
                                      ],
                                    ),
                                    DetailTile("Landmark",
                                        widget.service.driverDetails.landmark,
                                        controller: _driverLandmark.controller),
                                    Container(
                                      alignment: Alignment.centerLeft,
                                      margin: EdgeInsets.symmetric(
                                          vertical: 5, horizontal: 20),
                                        ...
                                        Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) => ImageViewer(
                                                    imageUrl:
                                                        "${APIConfig.baseUrl}/${driverUrl}/${widget.service.driverDetails.image}")));
                                      },
                                      child: Container(
                                        width: 60.w,
                                        height: 120,
                                    ...
                                    Container(
                                      ...
                                      margin: EdgeInsets.symmetric(
                                          vertical: 5, horizontal: 20),
                                      child: Text("Driving license Image",
                                          style: Theme.of(context)
                                              .textTheme
                                              .bodyMedium!
                                              .copyWith(
                                      ...
                                      onTap: () {
                                        Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) => ImageViewer(
                                                    imageUrl:
                                                        "${APIConfig.baseUrl}/${dlUrl}/${widget.service.driverDetails.dlImage}")));
                                      },
                                      child: Container(
                                        width: 60.w,
                                        height: 120,
  ...
  Widget _buildImageLayout({required void Function(ImageUrl,int) onDeleteClick}){

    List<Widget> _widgets =[];
    for(int i=0; i< listOfImages.length; i++){
        var _element =  listOfImages[i];
            ...
            child: Row(
              ...
              children: [
                Container(
                  width: 80,
                  height: 60,
                  child:_element.isNetwork
                      ? CachedNetworkImage(imageUrl: _element.url!)
                      : Image.file(File(_element.url!)),
                ),
                Container(
                  child: IconButton(
                    onPressed: () {
                     onDeleteClick(_element,i);
                    },
                    icon: Icon(
                      Icons.delete,
                      color: Colors.red,
  ...
  void update(AuthProvider auth) async {
    ...
    for (int j = 0; j < listOfImages.length; j++) {
      if (listOfImages[j].isNetwork == false) {
        data["pmg${j + 1}"] =
            await MultipartFile.fromFile(listOfImages[j].url!);
      }
    }
    try {
      CustomLogger.debug(data);
  ...
  Widget DetailTile(String header, String? body,
    ...
    return Container(
        ...
        child: TextFormField(
          ...
          validator: (value) {
            if (requiredField && canEdit) {
              if (value?.length == 0) {
                return "Required field $header";
              }
              if (isPinCode) {
  ...
  void deleteService(AuthProvider auth) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Service successfully deleted")));
      Navigator.pop(context);
    } catch (e) {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text(e.toString())));
