...
class _SingleServiceState extends State<SingleService> {
                ...
                child: Container(
                  ...
                  child: Column(
                          ...
                          children: [
                                ...
                                Container(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    style: ElevatedButton.styleFrom(
                                      ...
                                      backgroundColor: !canEdit?Colors.white:Theme.of(context).primaryColorDark,
                                    ),
                                    onPressed: (){
                                      setState(() {
                                        productImages = [];
                                    ...
                                    child: Icon(Icons.edit,color: !canEdit?Colors.blue:Colors.white,),
                                  ),
                                ),Container(
                                  alignment: Alignment.bottomRight,
                                  child: IconButton(
                            ...
                            DetailTile("Address", "${auth.user?.officeLandmark??""}, ${auth.user?.officeArea}, ${auth.user?.officeCity}-${auth.user?.officeZip},${auth.user?.officeState??""},${auth.user?.officeCountry?.name??""}",controller: _address.controller,editable: false,big: true),
                            ...
                            Row(
                            children: [
                              Expanded(child:DetailTile("Price", widget.service.price,controller: _price.controller,digits:true),),
  ...
  Widget DetailTile(String header,String? body,{TextEditingController? controller,bool editable=true,bool big=false,bool digits=false}){
