...
/*   String? videoPath; */
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: Consumer<DropDownOptionProvider>(builder: (context, state, child) {
                  ...
                  child: SingleChildScrollView(
                    child: Column(children: <Widget>[
                      CustomMaterialBox(listOfChildren: [
                        Padding(
                          ...
                          child: ExpansionTile(
                            shape: OutlineInputBorder(
                                ...
                                borderSide:
                                    BorderSide(color: UIColor.theme_color)),
                        ...
                        InputField("Company Name", _companyName, isRequired: false),
                        InputField("Address", _companyAddress,
                            autoComplete: true),
        ...
        /* return FutureBuilder(future: Future.wait([_locationFuture]),
          builder: (context, snapshot) {
        return  Scaffold(
            appBar:  AppBar(
              backgroundColor: UIColor.theme_color,
                ...
                child: SingleChildScrollView(
                  child: Column(children: <Widget>[
                    CustomMaterialBox(listOfChildren: [
                      ...
                      InputField("Pin Code", _pinCode, autoComplete: false, validatePin: true,digits: true),
                      Padding(
                        padding: textInputPadding,
                        child:  snapshot.connectionState ==
                            ConnectionState.waiting
...
/*    String countryId = DefaultCountries.firstWhere(
            (element) => element["name"] == selectedCountry)["id"]
        .toString();*/
        ...
        children: [
          Container(
            ...
            child: widget.filePath == null
                ? Text("Select Image")
                : widget.network
                    ? CachedNetworkImage(imageUrl: widget.filePath!)
