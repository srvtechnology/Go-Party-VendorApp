  ...
  runApp(DevicePreview(
      ...
      builder: (context) => ResponsiveSizer(
            builder: (context, orientation, type) => MultiProvider(
              ...
              child:
                  Consumer<ShowCaseProvider>(builder: (context, state, child) {
                if (state.isLoading) {
                    ...
                    return MaterialApp(
                      ...
                      routes: {
                        SplashScreen.routeName: (context) =>
                            SafeArea(child: const SplashScreen()),
                        SignIn.routeName: (context) =>
                            SafeArea(child: SignIn()),
                        SignUp.routeName: (context) =>
                            SafeArea(child: SignUp()),
                        MainPage.routeName: (context) =>
                            const SafeArea(child: MainPage()),
                        NotificationPage.routeName: (context) =>
                            const SafeArea(child: NotificationPage()),
                        Homepage.routeName: (context) =>
                            SafeArea(child: Homepage()),
                        OtpPageRoute.routeName: (context) =>
                            const SafeArea(child: OtpPageRoute()),
                        serviceListRoute.routeName: (context) =>
                            const SafeArea(child: serviceListRoute()),
                        AddServiceRoute.routeName: (context) =>
                            SafeArea(child: AddServiceRoute()),
                        SettingsPage.routeName: (context) =>
                            SafeArea(child: SettingsPage()),
                        AccountPage.routeName: (context) =>
                            SafeArea(child: AccountPage()),
                        WalletPage.routeName: (context) =>
                            SafeArea(child: WalletPage()),
                      },
                    );
                  }),
                );
