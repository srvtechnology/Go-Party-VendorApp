  ...
  factory ServiceModel.fromJson(Map json) {
    try {
      ...
      return ServiceModel(
          ...
          listImage :[
            ImageUrl(keyName: "image", url:  json["image"]?.isNotEmpty == true ? "${APIConfig.serviceImageUrl}"+json["image"] : null, isNetwork: true),
            ImageUrl(keyName: "image2",url: json["image2"]?.isNotEmpty == true ? "${APIConfig.serviceImageUrl}"+json["image2"] : null,isNetwork: true ),
            ImageUrl(keyName: "image3",url: json["image3"]?.isNotEmpty == true ? "${APIConfig.serviceImageUrl}"+json["image3"] : null,isNetwork: true ),
            ImageUrl(keyName: "image4",url: json["image4"]?.isNotEmpty == true ? "${APIConfig.serviceImageUrl}"+json["image4"] : null,isNetwork: true ),
            ImageUrl(keyName: "image5",url: json["image5"]?.isNotEmpty == true ? "${APIConfig.serviceImageUrl}"+json["image5"] : null,isNetwork: true ),
          ],
